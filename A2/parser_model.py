...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        # self.embeddings[w].shape: (batch_size, n_features, embed_size), we want (batch_size, n_features * embed_size)
        x = self.embeddings[w].reshape(w.shape[0], self.n_features * self.embed_size)
        ### TODO:
